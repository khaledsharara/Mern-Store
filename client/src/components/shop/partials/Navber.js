  ...
  return (
    <div>
      <div className={opacity ? "navbar1 navbar1-color" : "navbar1 "}>
        ...
        <h7 className="Websitename mt-3 cursor-pointer"> ZAM </h7>
      </div>
      <div
        className={`fullscreenmenu ${
          data.navberHamburger ? "active" : "inactive"
        }`}
      >
        <div
        ...
        <div className="sidebar">
          <div className="contentdiv">
            ...
            <div className="navbarcontent" id="homenav">
              ...
              <h1 id="homenavtext" className="cursor-pointer">
                Home
              </h1>
            </div>
            <div className="navbarcontent" id="shopnav">
              ...
              <h1 id="shopnavtext" className="cursor-pointer">
                Shop
              </h1>
            </div>
            <div className="navbarcontent" id="wishlistnav">
              ...
              <h1 id="wishlistnavtext" className="cursor-pointer">
                Wishlist
              </h1>
            </div>
            <div className="navbarcontent" id="contactnav">
              ...
              <h1 id="contactnavtext" className="cursor-pointer">
                {" "}
                Contact us
              </h1>
            </div>
            <div className="navbarcontent" id="contactnav">
              ...
              <h1 id="settingnavtext" className="cursor-pointer">
                {" "}
                Settings
              </h1>
            </div>
            <div className="loginbutton">
              <button type="button" className="loginbuttonstyle cursor-pointer">
                Sign Out
              </button>
            </div>
          </div>
      ...
      <div
        className={`fullscreenmenucart ${
          data.cartModal ? "active" : "inactive"
        }`}
      >
        <div
      ...
      <div
        className={`LoginScreenBlack ${
          data.loginSignupModal ? "active" : "inactive"
        }`}
        onClick={() => {
          loginModalOpen();
        }}
