...
import { editProduct, getAllProduct, uploadProductEditImage } from "./FetchApi";
...
const EditProductModal = (props) => {
  ...
  useEffect(() => {
    setEditformdata({
      ...
      pPriceOriginal: data.editProductModal.pPriceOriginal,
      pOffer: data.editProductModal.pOffer,
      isVariation: data.editProductModal.isVariation,
      pVariations: data.editProductModal.pVariations,
    });
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      //if pEditImages is null then set it to pImages
      if (!editformData.pEditImages) {
        editformData.pEditImages = editformData.pImages;
      } else {
        //if pEditImages is not null then upload images to firebase
        editformData.pEditImages = await uploadProductEditImage(
  ...
  return (
    <Fragment>
      ...
      >
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8 overflow-auto max-h-screen">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            <div className="flex space-x-1 py-4">
              ...
              <div className="w-1/2 flex flex-col space-y-1 space-x-1">
                ...
                <input
                  value={editformData.pPriceOriginal}
                  onChange={(e) =>
                    setEditformdata({
                      ...editformData,
                      error: false,
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex space-x-1 py-4">
                {editformData.isVariation === false ? (
                  ...
                  <div className="w-full flex flex-col space-y-1">
                    ...
                    <table className="min-w-full bg-white border border-gray-300">
                      ...
                      <tbody>
                        {editformData.pVariations ? (
                          editformData.pVariations.map((elem, key) => {
                            return (
                              <tr key={key}>
                                <td className="py-2 px-4 border-b">
                                  {elem.values.map((elem, key) => {
                                    return (
            ...
            <div className="flex flex-col mt-4">
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  {editformData.pImages.map((elem, key) => {
                    return (
                      <div key={key}>
                        <img
