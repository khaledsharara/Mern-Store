  ...
  return (
    <Fragment>
      <tr className="border-b">
        ...
        <td className="hover:bg-gray-200 p-2 text-center">EGP{order.amount}</td>
        <td className="hover:bg-gray-200 p-2 text-center">
          {order.transactionId}
        </td>
        <td className="hover:bg-gray-200 p-2 text-center">
          {order.user?.name ? order.user.name : order.guestInfo.name}
        </td>
        <td className="hover:bg-gray-200 p-2 text-center">
          {order.user?.email ? order.user.email : order.guestInfo.email}
        </td>
        ...
        <td className="hover:bg-gray-200 p-2 text-center">
          {order.transferSS ? (
            <a href={order.transferSS}>
              <img
                src={order.transferSS}
                alt="transferSS"
